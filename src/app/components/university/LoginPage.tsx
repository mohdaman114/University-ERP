...
import { GraduationCap, Mail, Lock, ArrowRight, Sparkles, UserCircle, CheckIcon, ChevronDownIcon, ChevronUpIcon } from 'lucide-react';
...
export function LoginPage() {
  ...
  const demoCredentials = [
    { label: 'Super Admin', value: 'super_admin', email: 'admin@university.edu', password: 'admin123' },
    { label: 'Student', value: 'student', email: 'student@university.edu', password: 'student123' },
    { label: 'Faculty', value: 'faculty', email: 'faculty@university.edu', password: 'faculty123' },
    { label: 'Examination', value: 'examination', email: 'exam@university.edu', password: 'exam123' },
    { label: 'Accounts', value: 'accounts', email: 'accounts@university.edu', password: 'accounts123' },
    { label: 'Library', value: 'library', email: 'library@university.edu', password: 'library123' },
  ];

  const fillDemoCredentials = (email: string, password: string, roleValue: string) => {
    setEmail(email);
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {demoCredentials.map((cred) => (
                      <Button
                        ...
                        size="sm"
                        className="text-xs"
                        onClick={() => fillDemoCredentials(cred.email, cred.password, cred.value)}
                        type="button"
                      >
                        {cred.label}
                      </Button>
